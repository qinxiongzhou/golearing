...
import (
	...
	"ch45-seckill/sk-admin/endpoint"
	"ch45-seckill/sk-admin/plugins"
	"ch45-seckill/sk-admin/service"
	"ch45-seckill/sk-admin/transport"
	"ch45-seckill/user-service/config"
