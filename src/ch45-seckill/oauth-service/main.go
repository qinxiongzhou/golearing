...
import (
	...
	localconfig "ch45-seckill/oauth-service/config"
	"ch45-seckill/oauth-service/endpoint"
	"ch45-seckill/oauth-service/plugins"
	"ch45-seckill/oauth-service/service"
	"ch45-seckill/oauth-service/transport"
	"ch45-seckill/pb"
	"ch45-seckill/pkg/bootstrap"
	conf "ch45-seckill/pkg/config"
	register "ch45-seckill/pkg/discover"
