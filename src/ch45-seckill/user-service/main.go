...
import (
	...
	localconfig "ch45-seckill/user-service/config"
	"ch45-seckill/user-service/endpoint"
	"ch45-seckill/user-service/plugins"
	"ch45-seckill/user-service/service"
	"ch45-seckill/user-service/transport"
